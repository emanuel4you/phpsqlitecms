  ...
  if(isset($_POST['new_menu_item']))
   {
    ...
    $dbr = Database::$content->prepare("INSERT INTO ".Database::$db_settings['menu_table']." (menu,sequence,name,title,link,section,accesskey,submenu) VALUES (:menu,:sequence,:name,:title,:link,:section,:accesskey)");
    $dbr->bindValue(':menu', trim($_POST['menu']), PDO::PARAM_STR);
